    ...
    public partial class FrmMain : Form
    {
        ...
        private void TrvList_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            if (e.Node.Text == "ANN1")
            {
                ...
                TxtDescription.Text = "앤 여왕은 1702년 3월 8일 잉글랜드와 스코틀랜드, Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum porro ullam magni amet incidunt eos numquam accusamus consequuntur reiciendis sapiente, corrupti iusto obcaecati unde ipsum, expedita illum dolor, quam velit.";
            }
            else if (e.Node.Text == "GRG1")
            {
                PcbPhoto.Image = Bitmap.FromFile("./Images/King_George_I.jpg");
                TxtDescription.Text = "조지 1세는" + "Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum porro ullam magni amet incidunt eos numquam accusamus consequuntur reiciendis sapiente, corrupti iusto obcaecati unde ipsum, expedita illum dolor, quam velit.";
            }
        }
    }
}
