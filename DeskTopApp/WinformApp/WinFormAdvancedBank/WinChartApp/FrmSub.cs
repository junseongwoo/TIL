...
namespace WinChartApp
{
    public partial class FrmSub : Form
    {
        ...
        private void FrmSub_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i < 10; i++)
            {
                ChtScore.Series[0].Points.AddXY(i, rand.Next(10, 100)); //수학
                ChtScore.Series[1].Points.AddXY(i, rand.Next(10, 100)); //영어
            }

            ChtScore.Series[0].ChartType = SeriesChartType.Bubble;
